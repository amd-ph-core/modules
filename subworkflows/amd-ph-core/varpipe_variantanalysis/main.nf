...
include { GATK4_MUTECT2 as GATK4_MUTECT2_ALL                                            } from "../../../modules/amd-ph-core/gatk4/mutect2/main"
include { GATK4_LEFTALIGNANDTRIMVARIANTS as GATK4_LEFTALIGNANDTRIMVARIANTS_ALL          } from "../../../modules/amd-ph-core/gatk4/leftalignandtrimvariants/main"
include { GATK4_FILTERMUTECTCALLS as GATK4_FILTERMUTECTCALLS_ALL                        } from "../../../modules/amd-ph-core/gatk4/filtermutectcalls/main"
include { SNPEFF_SNPEFF as VARPIPE_SNPEFF_ALL                                           } from "../../../modules/amd-ph-core/snpeff/snpeff/main"

include { GATK4_MUTECT2 as GATK4_MUTECT2_TARGETED                                       } from "../../../modules/amd-ph-core/gatk4/mutect2/main"
include { GATK4_LEFTALIGNANDTRIMVARIANTS as GATK4_LEFTALIGNANDTRIMVARIANTS_TARGETED     } from "../../../modules/amd-ph-core/gatk4/leftalignandtrimvariants/main"
include { GATK4_FILTERMUTECTCALLS as GATK4_FILTERMUTECTCALLS_TARGETED                    } from "../../../modules/amd-ph-core/gatk4/filtermutectcalls/main"
include { SNPEFF_SNPEFF as VARPIPE_SNPEFF_TARGETED                                      } from "../../../modules/amd-ph-core/snpeff/snpeff/main"
...
workflow VARPIPE_VARIANTANALYSIS {
    ...
    snpeff_cache        // path (mandatory): [ path(snpeff_cache) ]
    ...
    emit:
    ann_all           = VARPIPE_SNPEFF_ALL.out.vcf      // channel (mandatory): [ val(meta), path(vcf) ]
    ann_targeted      = VARPIPE_SNPEFF_TARGETED.out.vcf // channel (mandatory): [ val(meta), path(vcf) ]
    multiqc_inputs    = ch_multiqc_inputs               // channel (mandatory): [ path(snpeff_report) ]
