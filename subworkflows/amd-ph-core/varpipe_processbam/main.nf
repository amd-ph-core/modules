include { BWA_INDEX                                                             } from "../../../modules/amd-ph-core/bwa/index/main"
include { VARPIPE_BWAMEM                                                        } from "../../../modules/amd-ph-core/varpipe/bwamem/main"
include { SAMTOOLS_FAIDX                                                        } from "../../../modules/amd-ph-core/samtools/faidx/main"
include { PICARD_SORTSAM                                                        } from "../../../modules/amd-ph-core/picard/sortsam/main"
include { PICARD_MARKDUPLICATES                                                 } from "../../../modules/amd-ph-core/picard/markduplicates/main"
include { PICARD_CREATESEQUENCEDICTIONARY                                       } from "../../../modules/amd-ph-core/picard/createsequencedictionary/main"
include { SAMTOOLS_VIEW as SAMTOOLS_VIEW_UNMAPPED                               } from "../../../modules/amd-ph-core/samtools/view/main"
include { SAMTOOLS_VIEW                                                         } from "../../../modules/amd-ph-core/samtools/view/main"
include { SAMTOOLS_VIEW as SAMTOOLS_VIEW_MAPPED                                 } from "../../../modules/amd-ph-core/samtools/view/main"
...
include { SAMTOOLS_DEPTH                                                        } from "../../../modules/amd-ph-core/samtools/depth/main"
...
workflow VARPIPE_PROCESSBAM {
   ...
   // ALIGNERS
    ...
    multiqc_inputs        = ch_multiqc_inputs                                  // channel (mandatory): [ path(markduplicates_metrics) ]
